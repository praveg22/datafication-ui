...
function SignInPage() {
	...
	// console.log('errrormessgae', errorMessage);
	...
	function onSubmit({ email, password }: InferType<typeof schema>) {
		jwtService
			...
			.catch((errorResponse) => {
				// Check if the error is an array or a single object and handle accordingly
				// const errors = Array.isArray(errorResponse) ? errorResponse : [errorResponse];
				// console.log('dddd', errors, errorResponse);
				...
				<div className="mx-auto w-full max-w-320 sm:mx-0 sm:w-320">
					<div className="flex items-center">
						<img
							...
							alt="logo"
						/>
						<span className="text-4xl font-bold leading-tight tracking-tight">Datafication</span>
					</div>
